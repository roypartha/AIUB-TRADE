...
<main>
    <div class="body" >
        ...
        <input type="button" value="Post Your AD" onclick="window.location.href='sellPage';return false;"><br><br>
        <input type="button" value="All ADS" onclick="window.location.href='/project/products/list';return false;"><br><br>
    </div>
</main>
<footer>
