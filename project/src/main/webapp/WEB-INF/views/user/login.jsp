...
<header>
    ...
    <div class="header-center">
        <a href="#"><img src="AIUBTRADE.png" alt="Logo"></a>
    </div>
    <div class="header-right">
    <nav>
        <ul>
             <li><a href="${pageContext.request.contextPath}/users/create_dto">Signup</a></li>
...
<form:form action="store_dto" modelAttribute="user">
