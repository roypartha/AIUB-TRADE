...
<input type="button" value="Add Post" onclick="window.location.href='create';return false;">
...
<table>
    ...
    <c:forEach items="${products}" var="product">
        <tr>
            <c:url var="orderLink" value="/users/order_create">
            ...
            <td><a href="${orderLink}">Order</a></td>
        </tr>
    </c:forEach>
    </tbody>
</table>
